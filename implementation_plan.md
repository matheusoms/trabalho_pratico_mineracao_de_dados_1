...
> **Apresentação:** 16/04/2026 (HOJE) — Foco em execução rápida e objetiva.
...
> [!IMPORTANT]
> Este site foi criado **especificamente para prática de web scraping**, sem restrições no `robots.txt`, sem necessidade de autenticação e sem risco de violação de termos de uso. É a escolha mais segura para justificar perante o professor.
